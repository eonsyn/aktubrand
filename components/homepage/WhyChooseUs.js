...
function WhyChooseUs() {
  return (
   <section className="py-12 px-6 md:px-20 bg-[var(--background)] text-[var(--text-primary)]">
  <div className="max-w-5xl mx-auto text-center">
    <h2 className="text-3xl md:text-4xl font-bold mb-4">
      Why Choose <span className="text-[var(--accent)]">AKTU Quantum & Notes</span>?
    </h2>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4 md:px-10">
      {/* Card 1 */}
      <div className="bg-[var(--card-background)] rounded-2xl shadow-md hover:shadow-lg transition overflow-hidden flex flex-col border border-[var(--border)]">
        ...
        <div className="p-6 flex-1 flex flex-col justify-between">
          <h3 className="text-xl font-bold text-[var(--accent)] mb-2">AKTU Quantum Books PDF</h3>
      ...
      <div className="bg-[var(--card-background)] rounded-2xl shadow-md hover:shadow-lg transition overflow-hidden flex flex-col border border-[var(--border)]">
        ...
        <div className="p-6 flex-1 flex flex-col justify-between">
          <h3 className="text-xl font-bold text-[var(--accent)] mb-2">Handwritten Notes & PYQs</h3>
          <p className="text-[var(--text-secondary)] text-sm">
      ...
      <div className="bg-[var(--card-background)] rounded-2xl shadow-md hover:shadow-lg transition overflow-hidden flex flex-col border border-[var(--border)]">
        ...
        <div className="p-6 flex-1 flex flex-col justify-between">
          <h3 className="text-xl font-bold text-[var(--accent)] mb-2">Exam Tips & AKTU Blogs</h3>
          <p className="text-[var(--text-secondary)] text-sm">
    ...
    <div className="mt-10">
      <a
        href="/branch/cse"
        className="inline-block bg-[var(--accent)] text-white px-6 py-3 rounded-full font-medium hover:bg-[var(--accent-hover)] transition"
      >
