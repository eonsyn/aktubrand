...
function BlockAi({ article }) {
  ...
  return (
    <div className="w-full relative text-xl z-10">
      ...
      <div
        onClick={toggleBot}
        className="fixed bottom-4 right-4 z-50 bg-[#C8281D] hover:bg-red-700 text-white text-sm px-4 py-3 rounded-full flex items-center gap-2 cursor-pointer shadow-lg"
      >
